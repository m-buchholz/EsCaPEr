...
public class FadeInSymbols : MonoBehaviour
{
...
/// </summary>
     public void Fade()
    {
        ...
        GameObject cross = overlayBox.transform.GetChild(1).gameObject;
            if (gameObject.GetComponent<CollisionControllerForAssignmentSymbols>().isCorrect() == true)
            {
            ...
            else if (gameObject.GetComponent<CollisionControllerForAssignmentSymbols>().isCorrect() == false && gameObject.GetComponent<CollisionControllerForAssignmentSymbols>().isAssign() == true)
            {
